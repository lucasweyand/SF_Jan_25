...
//a href with Tartget click>hideNav
 // Select all links with the class 'targetHideNav'
 const targetLinks = document.querySelectorAll('.targetHideNav');

 targetLinks.forEach(link => {
   link.addEventListener('click', function (event) {
     console.log('Target link clicked:', this);

     // Hide the nav content
     if (activeContent) {
       console.log('Hiding active content:', activeContent.id);
       hideContent(activeContent);
       activeContent = null;
     } else {
       console.log('No active content to hide.');
     }
     ...
     // Hide nav background
     console.log('Hiding nav background.');
     hideNavBackground();
   });
 });
